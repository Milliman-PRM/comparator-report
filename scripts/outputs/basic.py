...
def main() -> int:
    ...
    outclaims_mem_followup_visits = outclaims_mem\
    .withColumn(
    ...
    cnt_followup_visits_within_7_days_numer=outclaims_mem_followup_visits.select(
            'elig_status',
            ...
            'cnt_followup_visits_within_7_days_numer_yn',
                ...
                spark_funcs.sum('cnt_followup_visits_within_7_days_numer_yn').alias('metric_value')
            )
    
    cnt_followup_visits_within_7_days_denom=outclaims_mem_followup_visits.select(
            'elig_status',
            ...
            'cnt_followup_visit_within_7_days_denom_yn',
                ...
                spark_funcs.sum('cnt_followup_visit_within_7_days_denom_yn').alias('metric_value')
            )
    ...
    basic_metrics = cnt_assigned_mems.union(
        ...
        cnt_followup_visits_within_7_days_numer_all
    ).union(
        cnt_followup_visits_within_7_days_denom
    ).union(
        cnt_followup_visits_within_7_days_denom_all          
    ).coalesce(10)
